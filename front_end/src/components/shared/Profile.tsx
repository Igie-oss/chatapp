			...
			<Popover>
				...
				<PopoverContent className=" flex flex-col gap-4 mr-2 md:mr-12 lg:mr-16">
					...
					<div className="flex flex-col gap-1">
						<h1 className="border-b pb-1 opacity-50">Settings</h1>
						<div className="flex flex-col gap-1 my-2">
							<Dialog>
								<DialogTrigger className="text-xs font-normal text-start  hover:bg-secondary/50 rounded-sm p-2">
						...
						<Dialog>
							...
							<DialogContent className="flex flex-col items-center gap-10 max-w-[22rem]">
								...
								<DialogFooter className="w-full flex items-center justify-between">
									<DialogClose className="w-1/2 bg-secondary h-8 rounded-md text-xs">
										Cancel
									</DialogClose>
									<SignOutBtn />
								</DialogFooter>
