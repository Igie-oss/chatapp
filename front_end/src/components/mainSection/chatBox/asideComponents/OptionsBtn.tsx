      ...
      {channel?.isGroup ? (
        <>
          <Dialog>
            <DialogTrigger
              type="button"
              className="w-full flex justify-start items-center px-2 h-10 rounded-md  border border-border  hover:bg-secondary/50"
            >
          ...
          <Dialog>
            <DialogTrigger
              type="button"
              className="w-full flex  bg-destructive/30 border-destructive border justify-start items-center px-2 h-10 rounded-md"
            >
